...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gray-900/80 backdrop-blur-sm border-t border-gray-800/50">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col items-center space-y-8">
          ...
          {/* Social Links */}
          <motion.div 
          className="flex justify-center space-x-5  transition-all duration-1000 delay-500"
          initial={{ opacity: 0, y: 20 }}
  ...
  >
    ...
    />
          ...
          <motion.div
            ...
            className="w-32 h-px bg-gradient-to-r from-transparent via-gray-600 to-transparent"
          />
